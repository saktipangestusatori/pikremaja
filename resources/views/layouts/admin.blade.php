...
<head>
    ...
    <meta content="pikremaja - Pusat Informasi Konseling Remaja" name="description" />
                    ...
                    <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link {{ Request::segment(1) == 'management-users' ? 'menuitem-active' : '' }}"
                                href="{{ route('management-users.index') }}"><i
                                    class="ti ti-users menu-icon"></i><span>Data Remaja</span></a>

                        </li>
                        <!--end nav-item-->

                        <li class="nav-item dropdown">
                            <a class="nav-link {{ Request::segment(1) == 'data-konselor' ? 'menuitem-active' : '' }}"
                                href="{{ route('data-konselor.index') }}"><i
                                    class="ti ti-users menu-icon"></i><span>Data Konselor</span></a>

                        </li>
                        <!--end nav-item-->

                        <li class="nav-item dropdown">
                            <a class="nav-link {{ Request::segment(1) == 'data-admin' ? 'menuitem-active' : '' }}"
                                href="{{ route('data-admin.index') }}"><i class="ti ti-users menu-icon"></i><span>Data
                                    Admin</span></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'category' ? 'menuitem-active' : '' }}"
                                href="{{ route('category.index') }}"><i class="ti ti-list menu-icon"></i><span>
                                    Informasi PIK Remaja</span></a>
                        </li>
                        <!--end nav-item-->


                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'konseling-admin' ? 'menuitem-active' : '' }}"
                                href="{{ route('konseling-admin.index') }}"><i
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'laporan' ? 'menuitem-active' : '' }}"
                                href="{{ route('laporan-admin.index') }}"><i class="ti ti-report menu-icon"></i><span>
