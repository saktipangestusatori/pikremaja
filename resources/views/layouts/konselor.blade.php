...
<body id="body" class="dark-sidebar">
    ...
    <div class="left-sidebar">
        <!-- LOGO -->
        <div class="brand">
            <a href="{{ url('dashboard-konselor') }}" class="logo">
                <span>
            ...
            <div class="menu-body navbar-vertical">
                <div class="collapse navbar-collapse tab-content" id="sidebarCollapse">
                    ...
                    <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'dashboard-konselor' ? 'menuitem-active' : '' }}"
                                href="{{ url('dashboard-konselor') }}"><i
                                    class="ti ti-dashboard menu-icon"></i><span>Beranda</span></a>
                        </li>
                        <!--end nav-item-->

                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'konseling-konselor' ? 'menuitem-active' : '' }}"
                                href="{{ route('konseling-konselor.index') }}"><i
                                    class="ti ti-friends menu-icon"></i><span>
                                    Konseling</span></a>
                        </li>
                        <!--end nav-item-->
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'laporan-konselor' ? 'menuitem-active' : '' }}"
                                href="{{ route('laporan-konselor.index') }}"><i
                                    class="ti ti-report menu-icon"></i><span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                        ...
                        <h6
                            ...
                            Notifikasi <span class="badge bg-soft-primary badge-pill">{{
                                App\Models\Pesan::where('read','0')->count() }}</span>
                        </h6>
                        <div class="notification-menu" data-simplebar>
                            @foreach (App\Models\Pesan::where('read','0')->get() as $item)


                            <!-- item-->
                            <a href="{{ route('konseling-konselor.edit', $item->id) }}" class="dropdown-item py-3">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center ms-2 text-truncate">
                                        ...
                                        <small class="text-muted mb-0">{!! $item->pesan !!}</small>
                                    </div>
                                    <!--end media-body-->
                                </div>
                                <!--end media-->
            ...
            <footer class="footer text-center text-sm-start">
                &copy; <script>
                    ...
                    class="text-muted d-none d-sm-inline-block float-end">Built with <i
                        class="mdi mdi-heart text-danger"></i> by saktic</span>
            </footer>
            <!-- end Footer -->
            <!--end footer-->
        </div>
