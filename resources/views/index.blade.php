    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="services.html">Konseling</a></li>
          <li><a href="pricing.html">pikremaja</a></li>
          ...
          <li><a class="get-a-quote" href="get-a-quote.html">Daftar</a></li>
        </ul>
      </nav><!-- .navbar -->
    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Pusat Informasi Konseling Remaja</h2>
          <p data-aos="fade-up" data-aos-delay="100">Sebagai sahabat remaja yang memberikan layanan informasi &
            konseling kesehatan reproduksi remaja sehingga terhindar dari adanya TRIAD KRR (Tiga Ancaman Dasar Kesehatan
            Reproduksi Remaja) </p>
        ...
        <div class="col-lg-6 order-1 order-lg-10 heri" data-aos="zoom-out">
          <img src="assets/img/heri.svg" class="img-fluid mb-5 mb-lg-0" alt="">
        </div>
