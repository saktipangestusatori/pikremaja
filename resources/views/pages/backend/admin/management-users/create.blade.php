                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('management-users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{ old('nik') }}" name="nik" id="nik"
                                    placeholder="Masukan Nomor Induk Kependudukan" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="date" value="{{ old('tanggallahir') }}"
                                    name="tanggallahir" id="tanggallahir" placeholder="Masukan Tanggal Lahir" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{ old('usia') }}" name="usia" id="usia"
                        ...
                        <div class="mb-3 row">
                            <label for="no_hp" class="col-sm-2 col-form-label">Foto</label>
                            <div class="col-sm-10">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select name="role" id="role" class="form-control" required>
                                    ...
                                    <option value="Konselor" {{ old('role')=='Konselor' ? 'selected' : '' }}>
                                        Konselor
                                    </option>
                                    <option value="Remaja" {{ old('role')=='Remaja' ? 'selected' : '' }}>Remaja
                                    </option>
                                </select>
                            </div>
                        </div>
