...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Tambah Konselor</a>
                        </li>

                    </ol>
                </div>
                <h4 class="page-title">Tambah Konselor</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('data-konselor.index') }}" class="btn btn-primary mb-3"><i
                    ...
                    @endif
                    <form action="{{ route('data-konselor.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select name="role" id="role" class="form-control" required>
                                    ...
                                    <option value="Konselor" {{ old('role')=='Konselor' ? 'selected' : '' }}>Konselor
                                    </option>
                                    <option value="Remaja" {{ old('role')=='Remaja' ? 'selected' : '' }}>Remaja</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
