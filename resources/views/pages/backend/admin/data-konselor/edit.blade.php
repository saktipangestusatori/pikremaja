            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Edit Konselor</a>
                        </li>

                    </ol>
                </div>
                <h4 class="page-title">Edit Konselor</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('data-konselor.update', $user->id) }}" method="POST"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select name="role" id="role" class="form-control" required>
                                    ...
                                    <option value="Konselor" {{ $user->role=='Konselor' ? 'selected' : '' }}>Konselor
                                    </option>
                                    <option value="Remaja" {{ $user->role=='Remaja' ? 'selected' : '' }}>Remaja</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
