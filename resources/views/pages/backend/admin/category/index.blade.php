...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <!--end nav-item-->
                        <li class="breadcrumb-item"><a href="#">Informasi Konseling</a>
                        </li>

                    </ol>
                </div>
                <h4 class="page-title">Informasi Konseling</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('category.create') }}" class="btn btn-primary"><i class="mdi mdi-plus-circle"></i>
                        Tambah Informasi
                    </a>
                        ...
                        <table class="table" id="table-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('backend/images/foto/'.$item->foto) }}" alt="" width="50">
                                    </td>
                                    <td>
                                        ...
                                        <form class="d-inline" action="{{ route('category.destroy', $item->id) }}"
