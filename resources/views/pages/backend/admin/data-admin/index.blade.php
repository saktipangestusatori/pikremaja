...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Data Admin PIK Remaja</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('data-admin.create') }}" class="btn btn-primary"><i
                        ...
                        <table class="table" id="table-datatables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('data-admin.edit', $user->id) }}" title="Edit"
                                            class="btn btn-warning btn-sm"><i class="mdi mdi-square-edit-outline"></i>
                                        </a>
                                        <a href="{{ route('data-admin.show', $user->id) }}" title="Ganti Password"
                                            class="btn btn-info btn-sm"><i class="mdi mdi-shield-key"></i>
                                        </a>

                                        <form class="d-inline" action="{{ route('data-admin.destroy', $user->id) }}"
