...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Beranda Konselor</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
    ...
    <div class="row">
        ...
        <!--end col-->
        <div class="col-md-3">
            <a href="{{ route('laporan-konselor.index') }}">
                <div class="card report-card">
                    <div class="card-body">
                        <div class="row d-flex justify-content-center">
                            <div class="col">
                                <p class="text-dark mb-1 fw-semibold">Laporan Konseling</p>
                                <h4 class="font-22 fw-bold">{{ $balasan }}</h4>
